function LassoSpectralFeatureRandomSampling(DataFile, timeofRepeatition)
...
%     figure, imagesc(reshape(trainingMap,[m,n])); % check the training samples 
    ...
    % use lasso/partial least square to select the discriminative histograms

    [B,FitInfo] = lasso(mtrainingData, mtrainingLabels);
